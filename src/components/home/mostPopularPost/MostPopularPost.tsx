  ...
  return (
    <div className="flex justify-center bg-[#f7f7f7] ">
      <div className="flex flex-col items-center w-full px-4">
        <div className="flex flex-col justify-center gap-5 w-full sm:w-[460px] pt-20 pb-14">
          <h3 className="text-red-500 font-bold text-xl text-center">Latest News</h3>
          <h2 className="font-bold text-3xl sm:text-4xl text-center ">Most Popular Post</h2>
